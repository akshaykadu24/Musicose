import {
  ...
  import { getearbudproduct, getheadphoneproduct, getSingleData } from "../../redux/product/product.action";
  ...
  const Headphone = () => {
    ...
    useEffect(() => {
      dispatch(getheadphoneproduct( low,high,sort));
      ...
      <>
       <Center py={12} backgroundColor={"rgb(245,245,245)"} >
         <Wrap spacing={"80px"} width={"90%"} justify="center">
           <ProductHeader products={products.headphone.products} category={"Headphone"} sort={sort}setSort={setSort}
            ...
            >
              ...
              // products.data.products.length > 0 &&
                products.headphone.products?.map((e, i) => ( 
