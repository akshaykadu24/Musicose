import {
  ...
  import { getbluetoothheadphoneproduct, getearbudproduct, getSingleData } from "../../redux/product/product.action";
  ...
  const BluetoothHeadphone = () => {
    ...
    useEffect(() => {
      dispatch(getbluetoothheadphoneproduct( low,high,sort));
      ...
      <>
       <Center py={12} backgroundColor={"rgb(245,245,245)"} >
         <Wrap spacing={"80px"} width={"90%"} justify="center">
           <ProductHeader products={products.bluetooth_headphone.products} category="Bluetooth Headphone"  sort={sort}setSort={setSort}
            ...
            >
              ...
              // products.data.products.length > 0 &&
                products.bluetooth_headphone.products?.map((e, i) => ( 
