import {
  ...
  import { getearbudproduct, getSingleData, getwatchproduct } from "../../redux/product/product.action";
  ...
  const Watch = () => {
    ...
    useEffect(() => {
      dispatch(getwatchproduct( low,high,sort));
           ...
           <ProductHeader products={products.watch.products} category={"Smart Watch"} sort={sort}setSort={setSort}
            ...
            >
              ...
              // products.data.products.length > 0 &&
                :products.watch.products?.map((e, i) => ( 
